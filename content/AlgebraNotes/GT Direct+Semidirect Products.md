...
- classifying finite abelian groups
	...
	- group structure of $(\mathbb{Z}_n)^\times$: we have $$\begin{align*}(\mathbb{Z}_p)^\times &\cong \mathbb{Z}_{p-1} \\ (\mathbb{Z}_4)^\times &\cong \mathbb{Z}_2 \\ (\mathbb{Z}_{2^m})^\times &\cong \mathbb{Z}_2 \times \mathbb{Z}_{2^{m-2}} \\ (\mathbb{Z}_{p^m})^\times &\cong \mathbb{Z}_{p-1} \times \mathbb{Z}_{p^m-1} \cong \mathbb{Z}_{(p-1)p^{m-1}} \end{align*}$$
...
- semidirect products
	- For groups $A, B$ and a group homomorphism $\varphi: B \to \text{Aut}(A)$, we define the product $$\begin{align*} (A \times B) \times (A \times B)&\to (A \times B) \\ (a_1, b_1) \cdot (a_2, b_2)&\mapsto (a_1, ( \; \varphi(b_1) a_2 \; ), b_1 b_2) \end{align*}$$This equips the set $A \times B$ with a group structure, in this case we denote this group $A \rtimes_\varphi B$  and call it the **(external) semidirect product of $A$ and $B$ with respect to $\varphi$**
...
- examples of semidirect products
	- if $A$ is abelian, the function $$\begin{align*} \iota: A &\to A \\ a &\mapsto a^{-1} \end{align*}$$ is an automorphism of order 2. Therefore, the function $$ \begin{align*} \varphi: \mathbb{Z_2} = \{ \pm 1\} &\to \text{Aut}(A) \\ 1 &\mapsto \text{id}_A \\ -1 &\mapsto \iota  \end{align*} $$ is a group homomorphism, and we can form the semidirect product $A \rtimes_\iota \mathbb{Z}_2$ 
	- for example, $$S_3 \cong \underbrace{ \langle (123) \rangle}_{\cong{\mathbb{Z}_3}} \rtimes \underbrace{ \langle (23) \rangle}_{\cong{\mathbb{Z}_2}}$$ as we have: $$ \begin{align*} (23)(123)(23)^{-1} &= (132) &= (123)^{-1} &= \iota((123)) \\ (23)(132)(23)^{-1} &= (123) &= (132)^{-1} &= \iota((132))\end{align*}$$
